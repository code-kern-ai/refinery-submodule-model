...
class DataManagerBusinessModels(Base):
    __tablename__ = Tablenames.BUSINESS_MODELS.value
...
class DataManagerDataConcepts(Base):
    __tablename__ = Tablenames.DATA_CONCEPTS.value
    __table_args__ = {"schema": "data_manager"}
    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    business_model_id = Column(
        UUID(as_uuid=True),
