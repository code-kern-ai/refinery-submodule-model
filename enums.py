...
class NotificationType(Enum):
    ...
    KNOWLEDGE_GRAPH_ALREADY_EXISTS = "KNOWLEDGE_GRAPH_EXISTS"
    KNOWLEDGE_GRAPH_NOT_SUPPORTED = "KNOWLEDGE_GRAPH_NOT_SUPPORTED"
    KNOWLEDGE_GRAPH_NOT_FOUND = "KNOWLEDGE_GRAPH_NOT_FOUND"
